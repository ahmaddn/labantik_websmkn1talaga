    <footer class="relative pt-20 pb-12 border-t border-slate-200 dark:border-zinc-800" id="section-kontak">
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="relative z-10 grid grid-cols-12 gap-5 xl:grid-cols-12">
                <div class="col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-4">
                    <div class="mb-5">
                        <a href="#!"><img src="{{ asset('assets/images/logosmk.png') }}" alt=""
                                class="hidden h-10 dark:block"></a>
                        <a href="#!"><img src="{{ asset('assets/images/logosmk.png') }}" alt=""
                                class="block h-10 dark:hidden"></a>
                    </div>
                    <p class="mb-5 text-slate-500 dark:text-zinc-400">Pembuatan website SMK Negeri 1 Talaga bertujuan
                        sebagai media informasi dan komunikasi antara sekolah dengan siswa, orang tua, dan masyarakat,
                        serta sebagai sarana untuk menampilkan identitas, profil, visi-misi, program keahlian, dan
                        prestasi sekolah. Website ini juga mendukung transparansi pengelolaan sekolah dan menunjukkan
                        komitmen sekolah dalam mengikuti perkembangan teknologi dan digitalisasi pendidikan.</p>
                ...
                <div class="col-span-12 md:col-span-4 lg:col-span-4 xl:col-span-3">
                    ...
                    <ul class="flex flex-col gap-3 text-15">
                        <li>
                            <a href="#!"
                                class="relative inline-block transition-all duration-200 ease-linear text-slate-500 dark:text-zinc-400 hover:text-slate-800 dark:hover:text-zinc-50 before:absolute before:border-b before:border-slate-200 dark:before:border-zinc-700 before:inset-x-0 before:bottom-0 before:w-0 hover:before:w-full before:transition-all before:duration-300 before:ease-linear"></a>
                        </li>
                    </ul>
                </div><!--end col-->
                <div class="col-span-12 md:col-span-4 lg:col-span-4 xl:col-span-3">
        ...
        <div class="pt-10 mt-16 text-center border-t text-slate-500 dark:text-zinc-400 dark:border-zinc-800 text-16">
            <p>
                ...
                </script> SMKN 1 Talaga & Develop by <a href="#!"
                    class="underline text-slate-800 dark:text-zinc-100">Labantik x ICT SMKN 1 Talaga</a>
            </p>
        </div>
    </footer>
